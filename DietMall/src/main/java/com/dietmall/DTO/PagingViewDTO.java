...
public class PagingViewDTO {
	...
	// 현재 페이지의 게시물 리스트 갯수
	private int board_NowBnoSize = 6;
	...
	// 전체 게시물 갯수, 현재 페이지
	public PagingViewDTO(int board_AllCount, int page_NowBno) {
		// 값 초기화
		// 총 게시물 수
	...
	public String toString() {
		return "PagingViewDTO [category_type=" + category_type + ", item_bno=" + item_bno + ", standard=" + standard
				+ ", page_NowBno=" + page_NowBno + ", page_StartBno=" + page_StartBno + ", page_EndBno=" + page_EndBno
