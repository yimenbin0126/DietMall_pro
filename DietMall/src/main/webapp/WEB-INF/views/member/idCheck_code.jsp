...
<body>
	...
	<section>
		...
		<div class="input_page">
			<form class="title" name="inputform">
				...
				<div class="input_type">
					...
					<button type="button" id="re_btn" class="btn">인증코드 재발송</button>
				</div>
		...
		<div class="complet_page">
			...
			<input type="button" id="btn_log" value="로그인하기" class="btn">
			<input type="button" id="btn_idpw" value="아이디/비밀번호 찾기" class="btn">
		</div>
