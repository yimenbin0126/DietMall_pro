...
<head>
    ...
    <title>회원가입</title>
    <link href="/resources/css/join-detail.css" rel="stylesheet">
    ...
    <section>
            <form action="/member/join-detail" method="post" id="content">
                ...
                <input type="text" name="userName" id="name" placeholder="이름을 입력해 주세요."
                    onfocus="this.placeholder=''" onblur="this.placeholder='이름을 입력해 주세요.'" required>
                ...
                <div id="bir">
                    <!-- 연도 -->
                    <div id="bir_yy">
                        <input type="text" name="userBirthyy" id="yy" class="int" maxlength="4" placeholder="ex.1999년(4자)"
                ...
                <div id="phone">
                    <input type="text" name="userTell" id="tel" placeholder="ex) 01012345678, -를 빼고 입력해주세요."
