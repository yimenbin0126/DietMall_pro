...
<body>
    ...
    <section>
        ...
        <div id="section_header_content">
            ...
            <div class="rank_top3_sale_content_all">
                <div id="rank3_image_1" class="rank_top3_sale_content">
                ...
                <div id="rank3_image_2" class="rank_top3_sale_content">
                ...
                <div id="rank3_image_3" class="rank_top3_sale_content">
        ...
        <div id="section_mid_content">
            ...
            <div id="saleitems_content_header">
                <strong class="saleitems_num_content">4개의 상품</strong>
                <div id="saleitems_condition" class="saleitems_num_content">
                    <ul>
                        <li>
                            <a>리뷰많은순</a>
                        </li>
            ...
            <div class="saleitems_content_middle">
                <div id="saleitems_image_1" class="saleitems_content_list">
                ...
                <div id="saleitems_image_2" class="saleitems_content_list">
                ...
                <div id="saleitems_image_3" class="saleitems_content_list">
                ...
                <div id="saleitems_image_4" class="saleitems_content_list" >
                ...
                <div id="saleitems_image_5" class="saleitems_content_list">
